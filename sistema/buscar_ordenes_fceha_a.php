...
<body>
	...
	<section id="container">
		...
		<?php 
			...
			$query = mysqli_query($conection,"SELECT o.id_orden, o.nro_orden, a.apellido, a.nombre, DATE_FORMAT(o.fecha_alta, '%d/%m/%Y') as fecha, o.monto, o.n_cuotas, o.estado, o.id_financiera FROM ordenes o inner join afiliados a on a.id_afiliado = o.id_afiliado WHERE $where and o.estado ='Autorizada' ORDER BY a.nombre ASC LIMIT $desde,$por_pagina ");
			...
			?>
				<tr>
					...
					<td><?php 
							...
							$query_pago = mysqli_query($conection,"SELECT distinct importe_cuota FROM pagos_oc WHERE estado =2 and nro_orden= '$nro_orden' ");
					...
					<td><?php 
						$nro_orden = $data["nro_orden"];
						$query_pago = mysqli_query($conection,"SELECT min(nro_cuota) FROM pagos_oc WHERE estado =2 and nro_orden= '$nro_orden' ");
						$cuota = mysqli_fetch_array($query_pago);
